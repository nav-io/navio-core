...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    public:
        ...
        // Fresh mainnet: no historical chain to assume-valid yet. Bump both as
        // mainnet history accumulates (see doc/release-process.md).
        ...
        // Plain unspendable coinbase. The genesis coinbase is never connected
        // (validation.cpp ConnectBlock special-cases the genesis hash and skips
        // it), so no BLSCT output is needed. The scriptSig carries a hidden
        // message, kept here only in encoded form so it stays a puzzle to be
        // discovered by inspecting the genesis block. Block nVersion keeps the
        // BLSCT version bit.
        const std::vector<unsigned char> genesisMsg = ParseHex("507269766163792069732074686520706f77657220746f2073656c6563746976656c792072657665616c206f6e6573656c6620746f2074686520776f726c642e");
        const std::string pszTimestamp(genesisMsg.begin(), genesisMsg.end());
        const CScript genesisOutputScript = CScript() << OP_RETURN;
        genesis = CreateGenesisBlock(pszTimestamp.c_str(), genesisOutputScript, 1782910800, 0, 0x207fffff, 0x40000000UL, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0af3c23ae1ac4910693b7187ac61641d16d1cf49cba7acf8649d48e831d86b13"));
        assert(genesis.hashMerkleRoot == uint256S("0x96f8dfcc3c433012bc9d4b42e85fe543936609f87fce2cc9d5484383ee2f9aaf"));
        ...
        vSeeds.emplace_back("seed.nav.io.");
