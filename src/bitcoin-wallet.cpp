...
static void SetupWalletToolArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-mnemonicpassphrase", "Optional BIP-39 passphrase used to extend the mnemonic when deriving the wallet keys. Only for 'create'. Requires -blsct. Cannot be combined with '-seed'. Must be ASCII when creating a new wallet, since no NFKD normalization is applied; a non-ASCII passphrase is still accepted, with a warning, when restoring with -mnemonic.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
