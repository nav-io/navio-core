...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-blsctproofv2height=<n>", "Set the BLSCT proof transcript v2 activation height (*blsctregtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
#if HAVE_SYSTEM
