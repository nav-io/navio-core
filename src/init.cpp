...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-blsctproofv2height=<n>", "Set the BLSCT proof transcript v2 activation height (*testnet/blsctregtest-only). CONSENSUS-FORKING: every node on the network must use the same value.", ArgsManager::ALLOW_ANY, OptionsCategory::DEBUG_TEST);
#if HAVE_SYSTEM
