...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "nbpregisterguardian", 0, "bond_amount" },
    { "nbpwithdrawbond", 0, "bond_amount" },
    { "nbpaggregatesigs", 0, "signatures" },
    { "nbpclaimdeposit", 0, "eth_chain_id" },
    { "nbpclaimdeposit", 3, "amount" },
    { "nbpburntoeth", 0, "eth_chain_id" },
    { "nbpburntoeth", 2, "amount" },
    { "nbpresolve", 2, "verdict" },
    { "nbpresolve", 5, "refund_amount" },
    { "nbpslash", 0, "evidence_type" },
    { "nbpslash", 6, "reward_amount" },
