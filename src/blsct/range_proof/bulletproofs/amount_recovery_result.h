...
#ifndef NAVIO_BLSCT_RANGE_PROOF_BULLETPROOFS_AMOUNT_RECOVERY_RESULT_H
#define NAVIO_BLSCT_RANGE_PROOF_BULLETPROOFS_AMOUNT_RECOVERY_RESULT_H
...
#endif // NAVIO_BLSCT_RANGE_PROOF_BULLETPROOFS_AMOUNT_RECOVERY_RESULT_H
