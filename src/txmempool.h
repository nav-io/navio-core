...
public:
     ...
     */
    void UpdateTransactionsFromBlock(const std::vector<uint256>& vHashesToUpdate, bool skip_descendant_limits = false) EXCLUSIVE_LOCKS_REQUIRED(cs, cs_main) LOCKS_EXCLUDED(m_epoch);
