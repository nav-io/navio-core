...
static void CoinSelection(benchmark::Bench& bench)
{
    ...
    for (const auto& wtx : wtxs) {
        ...
        available_coins.coins[OutputType::BECH32].emplace_back(COutPoint(wtx->tx->vout[0].GetHash()), txout, /*depth=*/6 * 24, CalculateMaximumSignedInputSize(txout, &wallet, /*coin_control=*/nullptr), /*spendable=*/true, /*solvable=*/true, /*safe=*/true, wtx->GetTxTime(), /*from_me=*/true, /*fees=*/ 0);
    }
...
static void add_coin(const CAmount& nValue, int nInput, std::vector<OutputGroup>& set)
{
    ...
    COutput output(COutPoint(tx.vout[nInput].GetHash()), tx.vout.at(nInput), /*depth=*/ 0, /*input_bytes=*/ -1, /*spendable=*/ true, /*solvable=*/ true, /*safe=*/ true, /*time=*/ 0, /*from_me=*/ true, /*fees=*/ 0);
    set.emplace_back();
