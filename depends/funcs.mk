...
define fetch_file
    ( $(call fetch_file_inner,$(1),$(2),$(3),$(4),$(5)) || \
      $(foreach mirror,$(6),$(call fetch_file_inner,$(1),$(mirror),$(3),$(4),$(5)) || ) \
...
$(1)_fetch_cmds ?= $(call fetch_file,$(1),$(subst \:,:,$$($(1)_download_path_fixed)),$$($(1)_download_file),$($(1)_file_name),$($(1)_sha256_hash),$($(1)_download_mirrors))
